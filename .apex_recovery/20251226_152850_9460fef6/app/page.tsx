...
export default function Home() {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (!target.closest('[data-booking-widget]')) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-screen w-full overflow-hidden flex items-center justify-center pt-24">
        ...
        <div className="absolute bottom-8 md:bottom-12 left-1/2 transform -translate-x-1/2 w-[90%] md:w-[70%] max-w-[900px] z-30" data-booking-widget>
          <div
          ...
          >
            ...
            <div className="relative flex-1">
              ...
              {showGuestPicker && (
                <div
                  className="absolute top-full mt-2 right-0 min-w-[120px] z-50"
                  style={{
      ...
      {/* Component 2: The Cradle of Iron - Geological Story */}
      <section 
        ref={(el) => { sectionRefs.current[0] = el; }}
        className="pt-16 md:pt-24 lg:pt-32 pb-8 md:pb-12 lg:pb-16 px-4 sm:px-6 md:px-12 relative overflow-hidden"
        style={{
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-stretch">
            <div className="flex flex-col scroll-fade h-full">
              ...
              >
                ...
                <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-heading text-white font-normal leading-tight mb-6">
                The Cradle
                <br />
                  <span className="text-champagne">of Iron</span>
              </h2>
                <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/80 mb-6 font-montserrat font-light">
                When you walk the ridges of Thabazimbi, you are walking on the rust of the world's first breath. These rocks are 2.5 billion years old, remnants of the Great Oxidation Event when the earth first "rusted."
              </p>
                <p className="text-base md:text-lg lg:text-xl leading-relaxed text-white/80 font-montserrat font-light">
                The game farms in this area rest on the Transvaal Supergroup, specifically the Penge Formation, which hosts massive high-grade hematite deposits. The presence of Banded Iron Formations creates a textured, layered landscape that photographs exceptionally well.
              </p>
            </div>
                      </div>
            <div className="flex flex-col scroll-fade h-full">
              ...
              >
                <div className="relative aspect-[4/3] overflow-hidden">
                  <Image
                    src="/images/The cradele.jpg"
                    alt="The Cradle of Iron - Banded Iron Formations, Thabazimbi"
                    fill
                    className="object-cover"
                  />
                ...
                <div className="p-8 md:p-10 flex-1 flex flex-col">
                  ...
                  <p className="text-white/70 font-montserrat text-sm md:text-base leading-relaxed mb-4 font-light">
                    Thabazimbi "Mountain of Iron" is defined by a hard duality: the unyielding permanence of iron and the resilient fluidity of the bushveld. This is not the lush garden of the Garden Route; it is a hard, ancient, and mineral-rich landscape that demands respect.
                  </p>
                  <Link
                    href="/origins"
      ...
      >
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid md:grid-cols-2 gap-6 md:gap-8">
            <Link
              href="/hunt"
              className="luxury-card group relative h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden transition-all duration-700"
              style={{
                background: "rgba(35, 31, 32, 0.4)",
                backdropFilter: "blur(10px)",
                WebkitBackdropFilter: "blur(10px)",
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 lg:p-12 z-20">
                <div 
                  ...
                  style={{
                    background: "linear-gradient(to top, rgba(15, 30, 44, 0.85) 0%, rgba(15, 30, 44, 0.7) 50%, rgba(15, 30, 44, 0) 100%)",
                    backdropFilter: "blur(8px)",
                    WebkitBackdropFilter: "blur(8px)",
                  }}
                >
                  <div className="w-16 h-px bg-white/30 mb-4 md:mb-6 group-hover:w-24 transition-all duration-500"></div>
                  <h3 
                    className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-heading text-white mb-3 md:mb-4 font-normal"
                    style={{
                      textShadow: '0 2px 8px rgba(0,0,0,0.5)'
                    }}
                  >
                  ...
                  <p 
                    className="text-white/90 font-montserrat text-xs md:text-sm tracking-[0.05em] font-light leading-relaxed mb-3"
                    style={{
                      textShadow: '0 1px 4px rgba(0,0,0,0.5)'
                    }}
                  >
                  ...
                  <p 
                    className="text-sunset-gold/90 font-montserrat text-[10px] md:text-xs tracking-[0.05em] font-light leading-relaxed mb-4"
                    style={{
                      textShadow: '0 1px 4px rgba(0,0,0,0.5)'
                    }}
                  >
                  ...
                  <div className="flex items-center gap-2 text-white text-sm font-montserrat uppercase tracking-[0.1em] font-light">
                  <span>Explore</span>
                  <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                  </svg>
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 lg:p-12 z-20">
                ...
                >
                  ...
                  <p 
                    className="text-white/90 font-montserrat text-xs md:text-sm tracking-[0.05em] font-light leading-relaxed mb-4"
                    style={{
                      textShadow: '0 1px 4px rgba(0,0,0,0.5)'
                    }}
                  >

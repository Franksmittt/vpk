...
export const metadata: Metadata = {
  ...
  description: 'Experience luxury lodge accommodations and conservation-led activities. From rhino micro-chipping to premium bushveld dining at Vaalpenskraal.',
  openGraph: {
    title: 'Sanctuary & Accommodations | Vaalpenskraal Game Reserve',
    description: 'Experience luxury lodge accommodations and conservation-led activities. From rhino micro-chipping to premium bushveld dining at Vaalpenskraal.',
    type: 'website',
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-12 py-16 md:py-24 lg:py-32 space-y-12 md:space-y-16">
        ...
        <section>
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20 items-start">
            ...
            <div className="h-[500px] border border-clay/20 bg-gradient-to-br from-clay/10 via-soil/10 to-charcoal/50 flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            {[
              ...
              >
                ...
                <div className="h-[200px] md:h-[250px] bg-gradient-to-br from-clay/10 via-soil/10 to-charcoal/50 border border-clay/10 flex items-center justify-center">

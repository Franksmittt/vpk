...
export const metadata: Metadata = {
  title: 'Trust & Logistics | Vaalpenskraal Game Reserve',
  description: 'Comprehensive hunting logistics in South Africa. We assist with SAPS 520 firearm permits, veterinary certificates, and professional trophy handling.',
  openGraph: {
    title: 'Trust & Logistics | Vaalpenskraal Game Reserve',
    description: 'Comprehensive hunting logistics in South Africa. We assist with SAPS 520 firearm permits, veterinary certificates, and professional trophy handling.',
    type: 'website',
    url: constructCanonicalUrl('/trust'),
  },
  alternates: {
    canonical: constructCanonicalUrl('/trust'),
  },
}
...
export default function TrustPage() {
  const jsonLd = {
    ...
    '@type': 'WebPage',
    name: 'Trust & Logistics | Vaalpenskraal Game Reserve',
    description: 'Comprehensive hunting logistics in South Africa. We assist with SAPS 520 firearm permits, veterinary certificates, and professional trophy handling.',
    url: constructCanonicalUrl('/trust'),
    mainEntity: {
      '@type': 'Service',
      serviceType: 'Hunting Logistics',
      areaServed: 'South Africa',
      description: 'Comprehensive hunting logistics including SAPS 520 firearm permits, veterinary certificates, and professional trophy handling.',
    },
  };
  return (

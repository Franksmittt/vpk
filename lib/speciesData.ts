...
export const speciesDatabase: SpeciesData[] = [
  ...
  },
  {
    ...
    nickname: "The Northern Giant",
    category: "spiral",
    investment: "$4,500",
    biometrics: {
      weight: { male: "650-940 kg (1,430-2,077 lb)", female: "300-600 kg (660-1,320 lb)" },
      height: { male: "170-180 cm (67-72 in)", female: "Similar" },
      hornLength: "30-35 inches average, trophy specimens exceed 40 inches",
    },
    biology: {
      digestiveType: "ruminant",
      feedingGuild: "mixed",
      primaryForage: "Leaves, shoots, fruits, tubers, melons",
      muzzleShape: "Intermediate",
      waterDependence: "Water-independent. Facultative heterothermy allows body temperature fluctuation to reduce water loss. Can survive on moisture-rich browse alone.",
      habitat: "Woodlands of Zambia, Zimbabwe, Mozambique, northern South Africa",
    },
    morphology: {
      cranial: "Intermediate muzzle width allows processing both browse and grass. Massive, pendulous dewlap increases surface area for heat dissipation.",
      dentition: "Large molar surface area to grind coarse material. Large rumen capacity allows intake of large quantities of lower quality fibrous material.",
      skeletal: "Titanic stature with robust skeleton designed to support immense weight. Elongated neural spines support massive neck muscles.",
      hoof: {
        dimensions: "114 mm x 95 mm (4.5 x 3.75 inches)",
        shape: "Rounded, bovine-like",
        distinctive: "Massive tracks, sharper definition of hoof halves than domestic cattle. Blunt dewclaws may register in soft substrate.",
        substrate: "Diverse - large surface area prevents sinking",
      },
      specialAdaptations: [
        "6-10 distinct vertical white stripes on flanks (distinguishing feature from Cape Eland)",
        "Dark, bushy tuft of hair on forehead (mop/toupee) holds scent from glandular secretions",
        "Massive pendulous dewlap for thermoregulation",
        "Facultative heterothermy - allows body temperature to rise during day, dissipates heat at night",
        "Loud clicking sound from knees/carpal joints during locomotion",
      ],
    },
    behavior: {
      social: "Gregarious but fluid fission-fusion society. Large aggregations of 500+ during wet season, fragment in dry season. Adult males often solitary or in small bachelor coalitions.",
      feeding: "Mixed feeders with strong preference for browse. Can push over small trees to access canopy foliage. Feed on succulents, melons, and tubers for moisture.",
      defense: "Sheer size is primary defense. Dominance established through horn wrestling rather than stabbing.",
      reproduction: "Large nursery herds during wet season. Males establish dominance through size and horn wrestling.",
      uniqueBehaviors: [
        "The 'Clicking' Mechanism - loud sound from carpal joints slipping over bone, serves as contact signal in dense mopane scrub",
        "Horn wrestling - bulls use horns for wrestling, not stabbing",
        "Facultative heterothermy - stores heat during day, dissipates at night",
        "Can cover up to 50 km in a day in search of food",
      ],
    },
    tracking: {
      trackMorphology: "Massive, rounded, bovine-like but distinguishable from domestic cattle by sheer size and sharper definition of hoof halves.",
      trackDimensions: "114 mm x 95 mm (4.5 x 3.75 inches) front tracks, hind tracks slightly smaller",
      gaitSignature: "Ground-eating trot maintained for hours. Hind foot often oversteps front footprint (over-tracking). Heavy indentation with central ridge.",
      behavioralSpoor: "Auditory component - clicking sound can be heard from hundreds of meters. Dung varies seasonally: distinct large pellets in winter (browsing), amorphous cattle-like plops in summer (grazing).",
      strategy: "Tracking is challenge of endurance rather than visual acuity. Assess fatigue by analyzing track depth and drag marks. Clicking sound provides auditory tracking aid.",
      keySigns: [
        "Clicking sound from knees/carpal joints",
        "Massive, rounded tracks with central ridge",
        "Over-tracking pattern (hind over front)",
        "Seasonal dung variation (pellets vs plops)",
      ],
    },
    hunting: {
      caliber: ".375 H&H Magnum (ideal), .300 Win Mag, .338 Win Mag",
      shotPlacement: "Halfway up shoulder body, tighter to crease. Heart sits very low.",
      trophy: "Massive bases, tight spiral. Both sexes carry horns. Trophy specimens exceed 40 inches.",
      meat: "Widely regarded as finest venison in Africa. Significant intramuscular fat (marbling), texture and flavor akin to high-quality herbaceous beef. Fine-grained, succulent, lacks strong gamey taint. Yields 250-400kg dressed meat.",
      difficulty: "Medium - Large size makes them easier to spot, but requires heavy caliber and endurance tracking",
    },
    description: "The monumental figure of the African bushveld, representing the pinnacle of bovid adaptation to variable environments. Distinguished by vertical white stripes and massive size, capable of approaching a metric ton.",
    conservationNarrative: "Supports habitat preservation for Africa's largest antelope subspecies, ensuring genetic diversity and ecosystem balance in northern woodland ecosystems.",
  },
  {
    id: "lechwe",
    name: "Lechwe",
    scientificName: "Kobus leche & Kobus megaceros",
    nickname: "The Wetland Specialist",
    category: "plains",
    investment: "$2,500",
    biometrics: {
      weight: { male: "100-120 kg (220-265 lb)", female: "77 kg (170 lb)" },
      height: { male: "100 cm (39 in)", female: "Similar" },
      hornLength: "26-35 inches (Red Lechwe), S-shaped (Nile Lechwe)",
    },
    biology: {
      digestiveType: "ruminant",
      feedingGuild: "grazer",
      primaryForage: "Aquatic grasses, reeds",
      muzzleShape: "Moderate",
      waterDependence: "Obligate wetland species, closely associated with permanent water",
      habitat: "Wetlands, floodplains, reedbeds (Okavango Delta, Kafue Flats, Caprivi Strip)",
    },
    morphology: {
      cranial: "Moderate muzzle width for grazing aquatic grasses and reeds in wetland environments.",
      dentition: "Adapted for processing aquatic vegetation and moisture-rich grasses.",
      skeletal: "Hindquarters noticeably higher than shoulders, providing muscular leverage for powerful bounding leaps through water. Clumsy on land but efficient in wetlands.",
      hoof: {
        dimensions: "70 mm x 50 mm (2.75 x 2 inches)",
        shape: "Extremely elongated and splayed",
        distinctive: "Hooves function like snowshoes to prevent sinking in soft mud. Widely splayed toes for mud traction.",
        substrate: "Wetlands/Mud - specialized for soft, muddy substrates",
      },
      specialAdaptations: [
        "Elongated, splayed hooves like snowshoes for mud",
        "Higher hindquarters than shoulders for aquatic locomotion",
        "Powerful bounding leaps through water",
        "Lekking behavior during breeding (Red Lechwe)",
        "Distinct sexual dimorphism (Nile Lechwe - males chocolate-brown to black with white saddle)",
      ],
    },
    behavior: {
      social: "Form herds in wetland areas. Red Lechwe males congregate in leks during breeding season.",
      feeding: "Grazers of high-protein, moisture-loving grasses in floodplains and reedbeds.",
      defense: "Flee into deep water when threatened, using swimming ability to escape terrestrial predators.",
      reproduction: "Red Lechwe exhibit rare lekking behavior - males display in clustered territories to attract females.",
      uniqueBehaviors: [
        "Lekking behavior - males congregate in small territories for display (Red Lechwe)",
        "Aquatic escape - flee into deep water when threatened",
        "Bounding gait through water - efficient in wetlands, clumsy on land",
        "Nile Lechwe males have chocolate-brown to black coat with white saddle patch",
      ],
    },
    tracking: {
      trackMorphology: "Elongated, widely splayed toes for mud traction. Distinctive snowshoe-like pattern.",
      trackDimensions: "70 mm x 50 mm (2.75 x 2 inches)",
      gaitSignature: "Bounding gait on land; powerful swimmer in water. Tracks show deep splay marks in mud.",
      behavioralSpoor: "Tracks concentrated near water sources. Mud wallows and feeding areas in reedbeds. Lek sites show clustered activity during breeding season.",
      strategy: "Focus tracking near permanent water sources. Look for mud wallows and feeding areas in reedbeds. Lek sites indicate breeding activity.",
      keySigns: [
        "Elongated, splayed tracks in mud",
        "Tracks concentrated near water",
        "Mud wallows and feeding areas",
        "Lek sites during breeding (Red Lechwe)",
      ],
    },
    hunting: {
      caliber: ".270 Win, .30-06, .300 Win Mag",
      shotPlacement: "Standard heart/lung shot. Be aware of higher hindquarters - may affect shot angle.",
      trophy: "Lyre-shaped horns (Red Lechwe), S-shaped (Nile Lechwe). SCI Gold: 35\"",
      meat: "Excellent quality - lean, tender, mildly sweet. Superior to Waterbuck, comparable to high-quality lamb.",
      difficulty: "Medium - Wetland habitat requires specialized approach. Aquatic escape behavior makes recovery challenging",
    },
    description: "Specialized wetland antelopes exhibiting profound morphological adaptations for semi-aquatic life. The elongated, splayed hooves function like snowshoes, and their higher hindquarters provide leverage for powerful aquatic leaps.",
    conservationNarrative: "Supports conservation of wetland ecosystems and specialized aquatic antelope species. Management contributes to floodplain habitat preservation.",
  },
  {
    id: "golden-wildebeest",
    name: "Golden Wildebeest",
    scientificName: "Connochaetes taurinus",
    nickname: "The Amber Ghost",
    category: "plains",
    investment: "$3,500",
    biometrics: {
      weight: { male: "230-275 kg (500-600 lb)", female: "160-200 kg (350-440 lb)" },
      height: { male: "140-152 cm (55-60 in)", female: "130-140 cm" },
      hornSpan: "83 cm max, massive boss (same as Blue Wildebeest)",
    },
    biology: {
      digestiveType: "ruminant",
      feedingGuild: "grazer",
      primaryForage: "Short grasses",
      muzzleShape: "Broad/Flat - same as Blue Wildebeest",
      waterDependence: "Water-dependent, requires regular access",
      habitat: "Open savannas, plains (managed game ranches due to predation vulnerability)",
    },
    morphology: {
      cranial: "Identical to Blue Wildebeest - broadest muzzle of any ruminant. Wide, flat mouth acts like lawnmower.",
      dentition: "Extremely hypsodont teeth, identical to Blue Wildebeest.",
      skeletal: "Identical skeletal structure to Blue Wildebeest - optimized for energy conservation.",
      hoof: {
        dimensions: "8-10 cm",
        shape: "Broad, boxy - same as Blue Wildebeest",
        distinctive: "Front hooves wider than hind. Parenthesis shape. Interdigital glands on forefeet.",
        substrate: "Plains/Mud - adapted for soft ground",
      },
      specialAdaptations: [
        "Autosomal recessive gene - homozygous recessive for golden phenotype",
        "Striking amber-gold coat with flaxen mane and tail",
        "Dark brown vertical neck stripes",
        "Lack of camouflage makes calves highly susceptible to predation",
        "Almost exclusively found on managed game ranches with predator control",
      ],
    },
    behavior: {
      social: "Gregarious, form herds. Behavior identical to Blue Wildebeest.",
      feeding: "Bulk grazer, identical feeding behavior to Blue Wildebeest.",
      defense: "Same defensive capabilities as Blue Wildebeest - notorious for absorbing lethal shots.",
      reproduction: "Genetic mechanism: calf must inherit recessive allele from both parents to be golden. Heterozygous individuals appear as normal Blue Wildebeest (splits).",
      uniqueBehaviors: [
        "Genetic origin - first Golden Wildebeest bulls captured in Limpopo River basin in early 1990s",
        "Recessive trait - requires both parents to carry gene",
        "Heterozygous 'splits' appear as normal Blue Wildebeest",
        "Predation vulnerability requires managed environment",
      ],
    },
    tracking: {
      trackMorphology: "Identical to Blue Wildebeest - large, broad, boxy tracks with parenthesis pattern.",
      trackDimensions: "8-10 cm",
      gaitSignature: "Same as Blue Wildebeest - broad tracks, interdigital scent trail.",
      behavioralSpoor: "Identical tracking characteristics to Blue Wildebeest. Circular evasion patterns, confusion tracks from herds.",
      strategy: "Same tracking strategy as Blue Wildebeest. Anticipate circular arc when tracking wounded animal.",
      keySigns: [
        "Circular evasion patterns",
        "Interdigital scent trail",
        "Confusion tracks from herds",
        "Amber-gold coat visible at distance (lack of camouflage)",
      ],
    },
    hunting: {
      caliber: ".300 Win Mag, .338 Win Mag, 9.3x62mm (premium bonded bullets mandatory)",
      shotPlacement: "Extremely low. Follow back of front leg up, bottom third of body. Heart sits very low.",
      trophy: "Thick boss, wide spread. Valued higher than Blue Wildebeest due to rarity. 18-20 year lifespan.",
      meat: "Same quality as Blue Wildebeest - coarse-grained, robust and gamey. Premier meat for Droewors.",
      difficulty: "High - Same toughness as Blue Wildebeest. Higher value due to color variant rarity",
    },
    description: "A color morph of the Blue Wildebeest driven by an autosomal recessive gene. The striking amber-gold coat with flaxen mane creates a stunning visual, but the lack of natural camouflage requires managed environments with predator control.",
    conservationNarrative: "Supports sustainable harvest of color variant genetics while maintaining herd health. Management of recessive traits contributes to genetic diversity research in game ranching.",
  },
  {
    id: "king-wildebeest",
    name: "King Wildebeest",
    scientificName: "Connochaetes taurinus",
    nickname: "The Royal Variant",
    category: "plains",
    investment: "$5,000",
    biometrics: {
      weight: { male: "230-275 kg (500-600 lb)", female: "160-200 kg (350-440 lb)" },
    ...
    biology: {
      ...
      muzzleShape: "Broad/Flat - same as Blue Wildebeest",
      waterDependence: "Water-dependent, requires regular access",
      habitat: "Open savannas, plains (managed game ranches due to extreme rarity)",
    },
    morphology: {
      cranial: "Identical to Blue Wildebeest - broadest muzzle of any ruminant.",
      dentition: "Extremely hypsodont teeth, identical to Blue Wildebeest.",
      skeletal: "Identical skeletal structure to Blue Wildebeest.",
      hoof: {
        dimensions: "8-10 cm",
        shape: "Broad, boxy - same as Blue Wildebeest",
        distinctive: "Front hooves wider than hind. Parenthesis shape.",
        substrate: "Plains/Mud - adapted for soft ground",
      },
      specialAdaptations: [
        "Distinct from Golden Wildebeest - different recessive mutation or combination of alleles",
        "White mane and tail",
        "Lighter body, often with silver-sheen",
        "Pinkish hue around eyes and muzzle",
        "Extreme rarity commands significantly higher trophy fees",
      ],
    },
    behavior: {
      social: "Gregarious, form herds. Behavior identical to Blue Wildebeest.",
      feeding: "Bulk grazer, identical feeding behavior to Blue Wildebeest.",
      defense: "Same defensive capabilities as Blue Wildebeest.",
      reproduction: "Likely driven by different recessive mutation or specific combination of recessive alleles distinct from Golden variant.",
      uniqueBehaviors: [
        "Distinct genetic mechanism from Golden Wildebeest",
        "White mane and tail create striking contrast",
        "Silver-sheen body coloration",
        "Pinkish facial features",
        "Extreme rarity in wild and managed populations",
      ],
    },
    tracking: {
      trackMorphology: "Identical to Blue Wildebeest - large, broad, boxy tracks.",
      trackDimensions: "8-10 cm",
      gaitSignature: "Same as Blue Wildebeest.",
      behavioralSpoor: "Identical tracking characteristics to Blue Wildebeest.",
      strategy: "Same tracking strategy as Blue Wildebeest.",
      keySigns: [
        "Circular evasion patterns",
        "Interdigital scent trail",
        "Confusion tracks from herds",
        "White mane visible at distance",
      ],
    },
    hunting: {
      caliber: ".300 Win Mag, .338 Win Mag, 9.3x62mm (premium bonded bullets mandatory)",
      shotPlacement: "Extremely low. Follow back of front leg up, bottom third of body.",
      trophy: "Thick boss, wide spread. Highest value due to extreme rarity. 18-20 year lifespan.",
      meat: "Same quality as Blue Wildebeest - coarse-grained, robust and gamey.",
      difficulty: "High - Same toughness as Blue Wildebeest. Highest value due to extreme rarity",
    },
    description: "The rarest of the Wildebeest color variants, distinct from the Golden. Features a white mane and tail, lighter silver-sheen body, and pinkish facial features. The extreme rarity commands the highest trophy fees among Wildebeest variants.",
    conservationNarrative: "Supports sustainable harvest of rare color variant genetics. Management of extreme rarity contributes to genetic diversity research and high-value game ranching.",
  },
  {
    id: "dapple-impala",
    name: "Dapple Impala",
    scientificName: "Aepyceros melampus",
    nickname: "The Saddleback",
    category: "plains",
    investment: "$1,200",
    biometrics: {
      weight: { male: "53-76 kg (117-168 lb)", female: "40-53 kg (88-117 lb)" },
    ...
    morphology: {
      cranial: "Identical to Common Impala - moderate muzzle width for seasonal switching.",
      dentition: "Moderately hypsodont, identical to Common Impala.",
      skeletal: "Identical skeletal structure to Common Impala.",
      hoof: {
        dimensions: "4-6 cm",
        shape: "Heart-shaped, neat, symmetrical",
        distinctive: "No dewclaws. Neat, oval, pointed.",
        substrate: "Bushveld - adapted for firm soils",
      },
      specialAdaptations: [
        "Saddleback pattern - disruption in pigmentation creates saddle effect or mottled pattern",
        "Color morph genetics - recessive trait",
        "All other characteristics identical to Common Impala",
        "High-value color variant in game ranching",
      ],
    },
    behavior: {
      social: "Large breeding herds or bachelor herds. Behavior identical to Common Impala.",
      feeding: "Seasonal switching: graze during wet season, browse during dry season. Identical to Common Impala.",
      defense: "High, kicking jumps with metatarsal glands. Same as Common Impala.",
      reproduction: "Rut in May. Same reproductive behavior as Common Impala.",
      uniqueBehaviors: [
        "Saddleback/mottled pigmentation pattern",
        "All behavioral characteristics identical to Common Impala",
        "Metatarsal gland scent marking",
        "Communal dung middens",
      ],
    },
    tracking: {
      trackMorphology: "Classic heart shape, neat and symmetrical. Identical to Common Impala.",
      trackDimensions: "4-6 cm",
      gaitSignature: "Neat, oval, pointed. Same as Common Impala.",
      behavioralSpoor: "Fresh dung piles on middens, forehead gland marks. Same as Common Impala.",
      strategy: "Look for dung middens and scent marking. Same tracking strategy as Common Impala.",
      keySigns: [
        "Communal dung middens",
        "Forehead gland marks",
        "Game paths beaten flat",
        "Saddleback pattern visible at distance",
      ],
    },
    hunting: {
      caliber: ".243 Win, .270 Win, 7x57 Mauser",
      shotPlacement: "Standard heart/lung shot. Small vital area.",
      trophy: "Lyre-shaped, heavy ridges. Valued higher than Common Impala due to color variant. SCI Gold: 52\"",
      meat: "Versatile and tender, identical to Common Impala. Standard for Potjiekos.",
      difficulty: "Low-Medium - Same as Common Impala, but higher value due to color variant",
    },
    description: "A color morph of the Common Impala characterized by a disruption in pigmentation that creates a saddle effect or mottled pattern. All biological and behavioral characteristics are identical to the Common Impala, with the unique coloration commanding higher value in game ranching.",
    conservationNarrative: "Supports sustainable harvest of color variant genetics. Management of recessive traits contributes to genetic diversity research while maintaining high-value game ranching.",
  },
  {
    id: "white-flanked-impala",
    name: "White-flanked Impala",
    scientificName: "Aepyceros melampus",
    nickname: "The High Contrast",
    category: "plains",
    investment: "$1,500",
    biometrics: {
      weight: { male: "53-76 kg (117-168 lb)", female: "40-53 kg (88-117 lb)" },
    ...
    morphology: {
      ...
      specialAdaptations: [
        "White-flanked pattern - retains red dorsal saddle but replaces tan flanks with pure white",
        "Stark, high-contrast appearance",
        "Recessive trait",
        "All other characteristics identical to Common Impala",
        "High-value color variant in game ranching",
      ],
    ...
    behavior: {
      ...
      reproduction: "Rut in May. Same reproductive behavior as Common Impala.",
      uniqueBehaviors: [
        "White flanks create high-contrast visual",
        "All behavioral characteristics identical to Common Impala",
        "Metatarsal gland scent marking",
        "Communal dung middens",
      ],
    ...
    tracking: {
      ...
      keySigns: [
        ...
        "Forehead gland marks",
        "Game paths beaten flat",
        "White flanks visible at distance",
      ],
    },
    hunting: {
      caliber: ".243 Win, .270 Win, 7x57 Mauser",
    ...
    description: "A color morph of the Common Impala that retains the red dorsal saddle but replaces the tan flanks with pure white, creating a stark, high-contrast appearance. This recessive trait commands high value in game ranching while maintaining all biological characteristics of the Common Impala.",
    conservationNarrative: "Supports sustainable harvest of color variant genetics. Management of recessive traits contributes to genetic diversity research while maintaining high-value game ranching.",
  },
];
